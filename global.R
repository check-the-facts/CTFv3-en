...
L_market$Geslacht[L_market$Geslacht == "T001038"] <- "Total"
L_market$Geslacht[L_market$Geslacht == '3000'] <- "Male"
L_market$Geslacht[L_market$Geslacht == '4000'] <- "Female"

#Persoons kenmerken
L_market$Persoonskenmerken[L_market$Persoonskenmerken == "1012600"] <- "Dutch Background"
L_market$Persoonskenmerken[L_market$Persoonskenmerken == "2012655"] <- "Western migrant background"
L_market$Persoonskenmerken[L_market$Persoonskenmerken == "2012657"] <- "Non-western migrant background"
L_market$Persoonskenmerken[L_market$Persoonskenmerken == "2012659"] <- "Unknown background"
L_market$Persoonskenmerken[L_market$Persoonskenmerken == "T001040"] <- "Total"
L_market$Persoonskenmerken[L_market$Persoonskenmerken == "A048134"] <- "International student"
L_market$Persoonskenmerken[L_market$Persoonskenmerken == "A048133"] <- "Not international student"


#Uitstromers Ho Met En Zonder Diploma
L_market$UitstromersHoMetEnZonderDiploma[L_market$UitstromersHoMetEnZonderDiploma == "A028566"] <- "Total"
L_market$UitstromersHoMetEnZonderDiploma[L_market$UitstromersHoMetEnZonderDiploma == "A025294"] <- "Hoger beroepsonderwijs"
L_market$UitstromersHoMetEnZonderDiploma[L_market$UitstromersHoMetEnZonderDiploma == "A043048"] <- "Hbo without hbo-diploma"
L_market$UitstromersHoMetEnZonderDiploma[L_market$UitstromersHoMetEnZonderDiploma == "A043047"] <- "Hbo with hbo-diploma"
...
L_market$UitstromersHoMetEnZonderDiploma[L_market$UitstromersHoMetEnZonderDiploma == "A043053"] <- "Wo without wo-diploma"
L_market$UitstromersHoMetEnZonderDiploma[L_market$UitstromersHoMetEnZonderDiploma == "A043052"] <- "Wo with wo-diploma"
...
#Arbeidsmarktpositie
L_market$Arbeidsmarktpositie[L_market$Arbeidsmarktpositie == "T001242"] <- "Total"
...
#Studierichting
L_market$Studierichting[L_market$Studierichting == "T001332"] <- "Total"
